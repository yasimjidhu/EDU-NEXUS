...
//       const timestampA = messages.find(msg => msg.conversationId === conversationIdA)?.createdAt || 0;
//       const timestampB = messages.find(msg => msg.conversationId === conversationIdB)?.createdAt || 0;
//       return new Date(timestampB).getTime() - new Date(timestampA).getTime();
//     });
//   }, [messagedStudents, messages, userData.user?._id]);

//   const renderLatestMessage = (conversationId: string) => {
//     const latestMessage = messages.find(msg => msg.conversationId === conversationId);
//     if (latestMessage) {
//       return (
