...
>(
    ...
    async (data: SignupData, { rejectWithValue }) => {
        try {
            const response = await axios.post('https://mcartecommerce.online/auth/signup', data);
...
>(
    ...
    async (data: OTPData, { rejectWithValue }) => {
        try {
            const response = await axios.post('https://mcartecommerce.online/auth/verify-otp', data);
            return response.data;
...
>(
    ...
    async (data:ForgotPasswordData, { rejectWithValue }) => {
      try {
        const response = await axios.post('https://mcartecommerce.online/auth/resendOtp',data);
...
>(
  ...
  async (data: LoginData, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.post('https://mcartecommerce.online/auth/login', 
        data,{
        headers:{
