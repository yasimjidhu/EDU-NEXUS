...
import { startCountdown, decrementTimer } from "../../components/redux/slices/otpSlice";
          ...
          <div className="h-full flex flex-col justify-center p-6 ">
            <form onSubmit={handleSubmit}>
              <div className="bg-gray-400 p-6 rounded-3xl h-full ">
                ...
                <h5 className="text-center mb-4 thin-font">Please enter the OTP to continue with resetting password</h5>
